...
parser.add_argument('-TDW_USER', type=str, default='tdw_ariaschen')
parser.add_argument('-TDW_PWD', type=str, default='chensi123456')
parser.add_argument('-TDW_GROUP', type=str, default='tl')
parser.add_argument('-MAX_TIME_STEP', type=int, default=10)
parser.add_argument('-batch_size', type=int, default=12)
parser.add_argument('-user_num', type=int, default=151888)
parser.add_argument('-item_num', type=int, default=3430)
